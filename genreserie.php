...
<img class="prof" src="profile.png" alt="profiel" width="70">
    ...
    <h1 class="welkom">sorteer per genre serie<h1>
    <div class="genres">
        <form method="POST">
          ...
          <button class="button-52" role="button" name="submit4" value="thriller"><p name="genre" value="thriller">thriller</p></button>
    ...
    <?php
      ...
      if (isset($_POST["submit"])) {
        $genre = $pdo->query("SELECT id, titel, score, foto, genre FROM serie WHERE genre='horror'");
        foreach ($genre as $row) {
          echo "<body style='color:white'>";
          echo "<tr><td><img width=100 src=" . $row['foto'] . "></td><td>" . $row['titel'] . "</td><td><a href='serie.php?id=" . $row['id'] . "'>></a></td></tr>";
        }
      }
      if (isset($_POST["submit1"])) {
        $genre = $pdo->query("SELECT id, titel, score, foto, genre FROM serie WHERE genre='actie'");
        foreach ($genre as $row) {
          echo "<body style='color:white'>";
          echo "<tr><td><img width=100 src=" . $row['foto'] . "></td><td>" . $row['titel'] . "</td><td><a href='serie.php?id=" . $row['id'] . "'>></a></td></tr>";
        }
      ...
      if (isset($_POST["submit2"])) {
        $genre = $pdo->query("SELECT id, titel, score, foto, genre FROM serie WHERE genre='sci-fi'");
        foreach ($genre as $row) {
          echo "<body style='color:white'>";
          echo "<tr><td><img width=100 src=" . $row['foto'] . "></td><td>" . $row['titel'] . "</td><td><a href='serie.php?id=" . $row['id'] . "'>></a></td></tr>";
        }
      ...
      if (isset($_POST["submit3"])) {
        $genre = $pdo->query("SELECT id, titel, score, foto, genre FROM serie WHERE genre='romantiek'");
        foreach ($genre as $row) {
          echo "<body style='color:white'>";
          echo "<tr><td><img width=100 src=" . $row['foto'] . "></td><td>" . $row['titel'] . "</td><td><a href='serie.php?id=" . $row['id'] . "'>></a></td></tr>";
        }
      ...
      if (isset($_POST["submit4"])) {
        $genre = $pdo->query("SELECT id, titel, score, foto, genre FROM serie WHERE genre='thriller'");
        foreach ($genre as $row) {
          echo "<body style='color:white'>";
          echo "<tr><td><img width=100 src=" . $row['foto'] . "></td><td>" . $row['titel'] . "</td><td><a href='serie.php?id=" . $row['id'] . "'>></a></td></tr>";
        }
      ...
      if (isset($_POST["submit5"])) {
        $genre = $pdo->query("SELECT id, titel, score, foto, genre FROM serie WHERE genre='comedy'");
        foreach ($genre as $row) {
          echo "<body style='color:white'>";
          echo "<tr><td><img width=100 src=" . $row['foto'] . "></td><td>" . $row['titel'] . "</td><td><a href='serie.php?id=" . $row['id'] . "'>></a></td></tr>";
        }
